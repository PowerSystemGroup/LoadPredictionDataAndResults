...
def data_split(D, T, D_max, D_min, season, weekday, festival, train_split=0.8, test_split=0.2, validation_split=0.05):
    x_1 = []
    x_21_D = []
    x_21_T = []
    x_22_D = []
    ...
    for i in range(8064, len_dataset):
        ...
        index_x_23 = [i - 672, i - 1344, i - 2016, i - 2688, i - 3360, i - 4032, i - 4704, i - 5376, i - 6048, i - 6720,
                      i - 7392, i - 8064]
    ...
    for i in range(24):
        ...
        X_train.append([X_1[i:num_train-num_val+i :24, :24 - i], X_21_D[i:num_train-num_val+i :24, :], X_21_T[i:num_train-num_val+i :24, :],
                        X_22_D[i:num_train-num_val+i :24, :], X_22_T[i:num_train-num_val+i :24, :], X_23_D[i:num_train-num_val+i :24, :],
                        X_23_T[i:num_train-num_val+i :24, :], X_3[i:num_train-num_val+i :24], X_4[i:num_train-num_val+i :24], X_5[i:num_train-num_val+i :24],
                        X_season[i:num_train-num_val+i :24, :], X_weekday[i:num_train-num_val+i :24, :], X_festival[i:num_train-num_val+i :24, :]])
        X_val.append(
...
X_train, X_val, X_test, Y_train, Y_val, Y_test = data_split(D[start_data_point: start_data_point + num_data_points],
                                                            ...
                                                            start_data_point: start_data_point + num_data_points],
                                                            festival[
                                                            start_data_point: start_data_point + num_data_points], 0.8,
                                                            0.2, 0.05)

## ----------------------------------------------------------------------------
from keras.models import Model
from keras.layers import Input, Dense, LSTM, concatenate, Activation, add, BatchNormalization, Reshape, Dropout
...
def get_layer_1(hour, input_Dd, input_Dw, input_Dm, input_Dr, input_Td, input_Tw, input_Tm, input_T, output_pre=[]):
    ...
    '''
    # LT_month
    concat1 = concatenate([input_Dd, input_Td])
    dense_concat1 = lstm_layer(concat1)

    # F_LT_month
    fuzzy_layer_L_month = FuzzyLayer(output_dim=14)
    fuzzy_L_month = fuzzy_layer_L_month(concat1)


    # LT_week
    concat2 = concatenate([input_Dw, input_Tw])
    dense_concat2 = lstm_layer(concat2)

    # F_LT_week
    fuzzy_layer_L_week = FuzzyLayer(output_dim=16)
    fuzzy_L_week = fuzzy_layer_L_week(concat2)


    # LT_day
    concat3 = concatenate([input_Dm, input_Tm])
    dense_concat3 = lstm_layer(concat3)

    # F_LT_day
    fuzzy_layer_L_day = FuzzyLayer(output_dim=6)
    fuzzy_L_day = fuzzy_layer_L_day(concat3)
    ...
    concat_FC2 = Dense(10, activation='selu', kernel_initializer='lecun_normal')(concat_mid)


    'F_FC2'
    f_Fc2 = concatenate([ fuzzy_L_month,  fuzzy_L_week,  fuzzy_L_day, fuzzy_S_W, input_festival])
    f_Fc2 = Dense(10, activation='selu', kernel_initializer='lecun_normal')(f_Fc2)



    inputs_FC_2 = tf.keras.layers.Lambda(lambda x: tf.stack(x, axis=1))([concat_FC2, f_Fc2])
    ...
    'FC1'
    dense_4 = concatenate([dense_Dr, dense_concat_date_info_1])
    Fc1 = Dense(10, activation='selu', kernel_initializer='lecun_normal')(dense_4)

    'F_FC1'
    f_Fc1 =concatenate([fuzzy_S_W, fuzzy_L_hour])
    f_Fc1 = Dense(10, activation='selu', kernel_initializer='lecun_normal')(f_Fc1)

    inputs_FC_1 = tf.keras.layers.Lambda(lambda x: tf.stack(x, axis=1))([Fc1, f_Fc1])
    output_FC_1 = tf.keras.layers.Attention()([inputs_FC_1, inputs_FC_1])
    output_FC_1 = tf.keras.layers.Flatten()(output_FC_1)
    FC1 = Dense(10, activation='selu', kernel_initializer='lecun_normal')(output_FC_1)
    FC1 = Dropout(0.3)(FC1)
...
output1, output_pre1 = get_layer_1(1, input1_Dd, input1_Dw, input1_Dm, input1_Dr, input1_Td, input1_Tw, input1_Tm,
                                   input1_T)
output2, output_pre2 = get_layer_1(2, input2_Dd, input2_Dw, input2_Dm, input2_Dr, input2_Td, input2_Tw, input2_Tm,
                                   input2_T, output_pre1)
output3, output_pre3 = get_layer_1(3, input3_Dd, input3_Dw, input3_Dm, input3_Dr, input3_Td, input3_Tw, input3_Tm,
                                   input3_T, output_pre2)
output4, output_pre4 = get_layer_1(4, input4_Dd, input4_Dw, input4_Dm, input4_Dr, input4_Td, input4_Tw, input4_Tm,
                                   input4_T, output_pre3)
output5, output_pre5 = get_layer_1(5, input5_Dd, input5_Dw, input5_Dm, input5_Dr, input5_Td, input5_Tw, input5_Tm,
                                   input5_T, output_pre4)
output6, output_pre6 = get_layer_1(6, input6_Dd, input6_Dw, input6_Dm, input6_Dr, input6_Td, input6_Tw, input6_Tm,
                                   input6_T, output_pre5)
output7, output_pre7 = get_layer_1(7, input7_Dd, input7_Dw, input7_Dm, input7_Dr, input7_Td, input7_Tw, input7_Tm,
                                   input7_T, output_pre6)
output8, output_pre8 = get_layer_1(8, input8_Dd, input8_Dw, input8_Dm, input8_Dr, input8_Td, input8_Tw, input8_Tm,
                                   input8_T, output_pre7)
output9, output_pre9 = get_layer_1(9, input9_Dd, input9_Dw, input9_Dm, input9_Dr, input9_Td, input9_Tw, input9_Tm,
                                   input9_T, output_pre8)
output10, output_pre10 = get_layer_1(10, input10_Dd, input10_Dw, input10_Dm, input10_Dr, input10_Td, input10_Tw,
                                     input10_Tm, input10_T, output_pre9)
output11, output_pre11 = get_layer_1(11, input11_Dd, input11_Dw, input11_Dm, input11_Dr, input11_Td, input11_Tw,
                                     input11_Tm, input11_T, output_pre10)
output12, output_pre12 = get_layer_1(12, input12_Dd, input12_Dw, input12_Dm, input12_Dr, input12_Td, input12_Tw,
                                     input12_Tm, input12_T, output_pre11)
output13, output_pre13 = get_layer_1(13, input13_Dd, input13_Dw, input13_Dm, input13_Dr, input13_Td, input13_Tw,
                                     input13_Tm, input13_T, output_pre12)
output14, output_pre14 = get_layer_1(14, input14_Dd, input14_Dw, input14_Dm, input14_Dr, input14_Td, input14_Tw,
                                     input14_Tm, input14_T, output_pre13)
output15, output_pre15 = get_layer_1(15, input15_Dd, input15_Dw, input15_Dm, input15_Dr, input15_Td, input15_Tw,
                                     input15_Tm, input15_T, output_pre14)
output16, output_pre16 = get_layer_1(16, input16_Dd, input16_Dw, input16_Dm, input16_Dr, input16_Td, input16_Tw,
                                     input16_Tm, input16_T, output_pre15)
output17, output_pre17 = get_layer_1(17, input17_Dd, input17_Dw, input17_Dm, input17_Dr, input17_Td, input17_Tw,
                                     input17_Tm, input17_T, output_pre16)
output18, output_pre18 = get_layer_1(18, input18_Dd, input18_Dw, input18_Dm, input18_Dr, input18_Td, input18_Tw,
                                     input18_Tm, input18_T, output_pre17)
output19, output_pre19 = get_layer_1(19, input19_Dd, input19_Dw, input19_Dm, input19_Dr, input19_Td, input19_Tw,
                                     input19_Tm, input19_T, output_pre18)
output20, output_pre20 = get_layer_1(20, input20_Dd, input20_Dw, input20_Dm, input20_Dr, input20_Td, input20_Tw,
                                     input20_Tm, input20_T, output_pre19)
output21, output_pre21 = get_layer_1(21, input21_Dd, input21_Dw, input21_Dm, input21_Dr, input21_Td, input21_Tw,
                                     input21_Tm, input21_T, output_pre20)
output22, output_pre22 = get_layer_1(22, input22_Dd, input22_Dw, input22_Dm, input22_Dr, input22_Td, input22_Tw,
                                     input22_Tm, input22_T, output_pre21)
output23, output_pre23 = get_layer_1(23, input23_Dd, input23_Dw, input23_Dm, input23_Dr, input23_Td, input23_Tw,
                                     input23_Tm, input23_T, output_pre22)
output24, output_pre24 = get_layer_1(24, input24_Dd, input24_Dw, input24_Dm, input24_Dr, input24_Td, input24_Tw,
...
def get_XY(X, Y):
    ...
    for i in range(24):
        ...
        Y_new.append(Y[i])
    X_new = X_new + [X[0][8], X[0][9], X[0][10], X[0][11],
                     X[0][12]]  # for shared input, use the data of hour 1 is enough.
...
for i in range(0):
    ...
    history_1 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                          epochs=350, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '1_weights.h5')
    print(str(i) + ' 1')

    history_2 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                          epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '2_weights.h5')
    print(str(i) + ' 2')

    history_3 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                          epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '3_weights.h5')
    print(str(i) + ' 3')

    history_4 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                          epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '4_weights.h5')
    print(str(i) + ' 4')

    history_5 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                          epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '5_weights.h5')
    print(str(i) + ' 5')

    history_6 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                          epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '6_weights.h5')
    print(str(i) + ' 6')

    history_7 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                          epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '7_weights.h5')
    print(str(i) + ' 7')

    history_8 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                          epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '8_weights.h5')
    print(str(i) + ' 8')

    history_9 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                          epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '9_weights.h5')
    print(str(i) + ' 9')

    history_10 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                           epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '10_weights.h5')
    print(str(i) + ' 10')

    history_11 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                           epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler1])

    model.save_weights('complete' + str(i + 1) + '11_weights.h5')
    print(str(i) + ' 11')

    history_12 = model.fit(X_train_fit, Y_train_fit,validation_data=(X_val, Y_val), \
                           epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler2])

    model.save_weights('complete' + str(i + 1) + '12_weights.h5')
    print(str(i) + ' 12')

    history_13 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                           epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler2])

    model.save_weights('complete' + str(i + 1) + '13_weights.h5')
    print(str(i) + ' 13')

    history_14 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                           epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler2])

    model.save_weights('complete' + str(i + 1) + '14_weights.h5')
    print(str(i) + ' 14')

    history_15 = model.fit(X_train_fit, Y_train_fit, validation_data=(X_val, Y_val),\
                           epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler3])

    model.save_weights('complete' + str(i + 1) + '15_weights.h5')
    print(str(i) + ' 15')

    history_16 = model.fit(X_train_fit, Y_train_fit,validation_data=(X_val, Y_val), \
                           epochs=50, batch_size=BATCH_SIZE, callbacks=[scheduler3])
    ...
    history_list.append(
        [history_1, history_2, history_3, history_4, history_5, history_6, history_7, history_8, history_9, history_10,
         history_11, history_12, history_13, history_14, history_15, history_16])
...
df2 = pd.DataFrame([dur1], columns=['TIME'])

# 将数据框保存到Excel文件中
df2.to_excel('all_time_xunlian.xlsx', index=False)
...
for i in tqdm(range(0, NUM_SNAPSHOT)):
    for j in range(i, NUM_SNAPSHOT):
        ...
        mape_df.to_excel('mape_values.xlsx')
