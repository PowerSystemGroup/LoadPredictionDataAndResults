...
def main():
    ...
    base_dirs = [
        os.path.join(".", "results", "ARIMA", "parking_time"),
        os.path.join(".", "results", "ARIMA", "kWhDelivered"),
    ]
    ...
    for run in range(1, n_runs + 1):
        ...
        for w in windows:
            ...
            try:
                ...
                folder1 = os.path.join(".", "results", "ARIMA", "parking_time", str(run))
            ...
            try:
                ...
                folder2 = os.path.join(".", "results", "ARIMA", "kWhDelivered", str(run))
    ...
    pd.DataFrame(metrics_all).to_csv("./results/ARIMA/metrics_mixed_dynamic.csv", index=False)
