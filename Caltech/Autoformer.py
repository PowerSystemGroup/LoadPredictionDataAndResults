...
def fit_autoformer_model(
    ...
    if len(X_train) == 0 or len(X_val) == 0:
        raise ValueError("The training or validation set is empty; training cannot proceed Autoformer")
...
def main():
    ...
    os.makedirs("./Caltech/results/Autoformer_strict", exist_ok=True)
    metrics_all = []
    ...
    base_dirs = [
        os.path.join(".", "Caltech", "results", "Autoformer_strict", "parking_time"),
        os.path.join(".", "Caltech", "results", "Autoformer_strict", "kWhDelivered"),
    ]
        ...
        for w in windows:
            ...
            try:
                ...
                save_curve_from_list(
                    ...
                    os.path.join(".", "Caltech", "results", "Autoformer_strict", "parking_time", run_str, f"convergence_parking_time_window_{w}.png"),
            ...
            try:
                ...
                save_curve_from_list(
                    ...
                    os.path.join(".", "Caltech", "results", "Autoformer_strict", "kWhDelivered", run_str, f"convergence_kWh_time_window_{w}.png"),
    ...
    pd.DataFrame(metrics_all).to_csv("./Caltech/results/Autoformer_strict/metrics_mixed_dynamic.csv", index=False)
    print("\nAll runs complete. Results saved to ./Caltech/results/Autoformer_strict/metrics_mixed_dynamic.csv")
