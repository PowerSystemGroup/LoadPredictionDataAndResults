...
def main():
    ...
    base_dirs = [
        os.path.join(".", "results", "jpl", "parking_time"),
        os.path.join(".", "results", "jpl", "kWhDelivered"),
    ]
    ...
    pd.DataFrame(metrics_all).to_csv("./results/jpl/metrics_mixed_dynamic.csv", index=False)
