...
def main():
    ...
    os.makedirs("./JPL/results/TFT_strict", exist_ok=True)
    metrics_all = []
    ...
    base_dirs = [
        os.path.join(".", "JPL", "results", "TFT_strict", "parking_time"),
        os.path.join(".", "JPL", "results", "TFT_strict", "kWhDelivered"),
    ]
        ...
        for w in windows:
            ...
            try:
                pt_fit = fit_tft_model(
                    ...
                    logger_root=os.path.join(".", "JPL", "results", "TFT_strict", "parking_time", run_str),
                ...
                save_curve_from_metrics(
                    pt_fit["metrics_csv"],
                    os.path.join(".", "JPL", "results", "TFT_strict", "parking_time", run_str, f"convergence_parking_time_window_{w}.png"),
            ...
            try:
                k_fit = fit_tft_model(
                    ...
                    logger_root=os.path.join(".", "JPL", "results", "TFT_strict", "kWhDelivered", run_str),
                    model_tag=f"window_{w}",
                    seed=run * 1000 + w,
                    max_epochs=35,
                    batch_size=128,
                ...
                save_curve_from_metrics(
                    k_fit["metrics_csv"],
                    os.path.join(".", "JPL", "results", "TFT_strict", "kWhDelivered", run_str, f"convergence_kWh_time_window_{w}.png"),
    ...
    pd.DataFrame(metrics_all).to_csv("./JPL/results/TFT_strict/metrics_mixed_dynamic.csv", index=False)
    print("\nAll runs complete. Results saved to ./JPL/results/TFT_strict/metrics_mixed_dynamic.csv")
